...
export async function GET() {
  ...
  const body = [
    ...
    `- [MCP](${siteUrl}/mcp): public unauthenticated streamable-http JSON-RPC (initialize, tools/list, tools/call). Tools: list_cedears, get_cedear, earnings. Discovery: ${siteUrl}/.well-known/mcp.json`,
    '',
    '## Páginas',
    '',
